# Support for Output Descriptors in Freecoin Core

Since Freecoin Core v0.17, there is support for Output Descriptors. This is a
...
on Freecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Freecoin Core wallets, a convenience function `combo` is
