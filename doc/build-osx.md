...
1. Clone the Freecoin Core source code:
...
2.  Build Freecoin Core:
    ...
    Configure and build the headless Freecoin Core binaries as well as the GUI (if Qt is found).
...
5.  Installation into user directories (optional):
    ...
    or
        ...
        cd ~/freecoin/src
        cp freecoind /usr/local/bin/
        cp freecoin-cli /usr/local/bin/
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/Freecoin"

    touch "/Users/${USER}/Library/Application Support/Freecoin/freecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Freecoin/freecoin.conf"

The first time you run freecoind, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
