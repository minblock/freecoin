...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid freecoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid freecoin address" in e.error['message'])
        ...
        # output 0 takes at least as much share of the fee, and no more than 2 lifetiparoshis more, than outputs 2 and 3
