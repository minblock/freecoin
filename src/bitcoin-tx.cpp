...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " freecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  freecoin-tx [options] <hex-tx> [commands]  Update hex-encoded freecoin transaction\n" +
            "or:     freecoin-tx [options] -create [commands]   Create hex-encoded freecoin transaction\n" +
            "\n";
