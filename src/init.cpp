...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/freecoin-project/freecoin>";
...
bool AppInitParameterInteraction()
{
    ...
    // 1-lifetiparoshi-fee transactions. It should be set above the real
