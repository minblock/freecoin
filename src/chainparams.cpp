...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585880204, 57972, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc45c10ca5c52b04bf70f173905b4e962ecd6e22284af390df13be91b9aa1ccea"));
        ...
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.freecoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("freecointools.com", "dnsseed.freecointools.com"));
        //vSeeds.push_back(CDNSSeedData("freecoinpool.org", "dnsseed.freecoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("freecointools.com", "testnet-seed.freecointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.freecoin.loshan.co.uk", true));
